...
import org.intellij.erlang.psi.ErlangMaybeExpression;
import org.intellij.erlang.psi.ErlangVisitor;
import org.intellij.erlang.sdk.ErlangSdkRelease;
import org.intellij.erlang.sdk.ErlangSdkType;
import org.jetbrains.annotations.NotNull;

public class Erlang25SyntaxInspection extends ErlangInspectionBase {
  @Override
  protected boolean canRunOn(@NotNull ErlangFile file) {
    ErlangSdkRelease release = ErlangSdkType.getRelease(file);
    return release == null || ErlangSdkRelease.V_25_0.isNewerThan(release);
  }
  ...
  protected ErlangVisitor buildErlangVisitor(@NotNull final ProblemsHolder holder, @NotNull LocalInspectionToolSession session) {
    return new ErlangVisitor() {
      ...
      public void visitMaybeExpression(@NotNull ErlangMaybeExpression o) {
        registerProblem(holder, o, "`maybe` expression require Erlang/OTP 25.0 with `-enable-feature maybe_expr`");
      }
    };
  }
}
