...
public final class ErlangBifTable {
  ...
  static {
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "abs", 1, "Number"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "exit", 1, "P1"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "external_size", 2, "Term, [Option]"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "halt", 1, "P1"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "halt", 2, "P1, P2"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "phash2", 2, "P1, P2"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "link", 1, "Pid"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "load_module", 2, "Module, Binary"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "localtime_to_universaltime", 2, "{Date1, Time1}, IsDst"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "nodes", 1, "Arg | [Arg]"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "port_info", 1, "Port"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "port_info", 2, "Port, Item"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "process_flag", 2, "Flag, Value"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "process_info", 2, "Pid, ItemSpec"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "register", 2, "RegName, Pid | Port"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "statistics", 1, "Type"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "term_to_binary", 1, "Term"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "term_to_binary", 2, "Term, [Option]"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "throw", 1, "P1"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "time", 0, ""));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "tl", 1, "List1"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "universaltime_to_localtime", 1, "{Date1, Time1}"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "port_call", 2, "P1, P2"));
    ...
    bifMap.putValue("math", new ErlangBifDescriptor("math", "cos", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "cosh", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "sin", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "sinh", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "tan", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "tanh", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "acos", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "acosh", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "asin", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "asinh", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "atan", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "atanh", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "erf", 1, "X"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "erfc", 1, "X"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "exp", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "log", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "log10", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "sqrt", 1, "P1"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "atan2", 2, "P1, P2"));
    bifMap.putValue("math", new ErlangBifDescriptor("math", "pow", 2, "P1, P2"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "make_tuple", 3, "Arity, Default, InitList"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "system_flag", 2, "Flag, Value"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "system_info", 1, "Type"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "system_monitor", 0, ""));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "system_monitor", 1, "undefined | {MonitorPid, Options}"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "system_monitor", 2, "MonitorPid, [Option]"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "error", 1, "P1"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "error", 2, "P1, P2"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "raise", 3, "P1, P2, P3"));
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "send", 3, "Dest, Msg, [Option]"));
    ...
    bifMap.putValue("ets", new ErlangBifDescriptor("ets", "safe_fixtable", 2, "Tab, true|false"));
    bifMap.putValue("ets", new ErlangBifDescriptor("ets", "slot", 2, "Tab, I"));
    bifMap.putValue("ets", new ErlangBifDescriptor("ets", "update_counter", 3, "Tab, Key, UpdateOp"));
    ...
    // Since R12B-2
    bifMap.putValue("ets", new ErlangBifDescriptor("ets", "update_element", 3, "Tab, Key, {Pos,Value}"));
    // Since R12B-4
    ...
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "nif_error", 1, "P1"));
    bifMap.putValue("erlang", new ErlangBifDescriptor("erlang", "nif_error", 2, "P1, P2"));
