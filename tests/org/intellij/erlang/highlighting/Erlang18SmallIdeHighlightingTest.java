...
public class Erlang18SmallIdeHighlightingTest extends ErlangHighlightingTestBase {
  ...
  protected LightProjectDescriptor getProjectDescriptor() {
    return new DefaultLightProjectDescriptor() {
      @Override
      public Sdk getSdk() {
        return ErlangSdkType.createMockSdk(SDK_HOME, ErlangSdkRelease.V_18_0);
      }
    };
  }
  ...
  public void testCorrectSdkReleaseIsReported() {
    assertEquals(ErlangSdkRelease.V_18_0.getOtpRelease(), Objects.requireNonNull(ErlangSdkType.getRelease(getProject())).getOtpRelease());
  }
