...
public class ErlangHeadMismatchFixTest extends ErlangQuickFixTestBase {
  ...
  public void testSimple() { doTest("Rename clause head"); }

  public void testFun_expr_delete() { doFunExprTest(); }
  public void testFun_expr_insert() { doFunExprTest(); }
  public void testFun_expr_rename() { doFunExprTest(); }

  private void doFunExprTest() {
