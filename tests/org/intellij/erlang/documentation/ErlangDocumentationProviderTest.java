...
public class ErlangDocumentationProviderTest extends ErlangLightPlatformCodeInsightFixtureTestCase {
  ...
  public void testExternalUrlSdkFunction() {
    doTestGetUrls("http://erlang.org/documentation/doc-5.9/lib/stdlib-1.18/doc/html/lists.html#foreach-2",
      "-module(test).\n" +
        "test() ->\n" +
  ...
  public void testExternalUrlSdkBif() {
    doTestGetUrls("http://erlang.org/documentation/doc-5.9/lib/stdlib-1.18/doc/html/lists.html#member-2",
      "-module(test).\n" +
        "test() ->\n" +
  ...
  public void testExternalUrlSdkModule() {
    doTestGetUrls("http://erlang.org/documentation/doc-5.9/lib/stdlib-1.18/doc/html/lists.html",
      "-module(test).\n" +
        "test() ->\n" +
