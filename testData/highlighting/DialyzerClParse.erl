...
-module(<error>dialyzer_cl_parse</error>).
...
init() ->
  ...
  DefaultOpts = #<error>options</error>{},
  put(dialyzer_include,           DefaultOpts#<error>options</error>.include_dirs),
  put(dialyzer_options_defines,   DefaultOpts#<error>options</error>.defines),
  put(dialyzer_options_files,     DefaultOpts#<error>options</error>.files),
  put(dialyzer_output_format,     formatted),
  put(dialyzer_filename_opt,      basename),
  put(dialyzer_options_check_plt, DefaultOpts#<error>options</error>.check_plt),
  ok.
