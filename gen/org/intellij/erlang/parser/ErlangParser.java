...
public class ErlangParser implements PsiParser {
  ...
  static boolean form_with_period(PsiBuilder builder_, int level_) {
    ...
    result_ = exitErrorRecordingSection(builder_, level_, result_, pinned_, _SECTION_RECOVER_, form_recover_parser_);
    return result_ || pinned_;
  }
  ...
  /* ********************************************************** */
  // !('.' | ';')
  static boolean function_clause_recover(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "function_clause_recover")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_NOT_, null);
    result_ = !function_clause_recover_0(builder_, level_ + 1);
    marker_.rollbackTo();
    result_ = exitErrorRecordingSection(builder_, level_, result_, false, _SECTION_NOT_, null);
    return result_;
  }
  ...
  // '.' | ';'
  private static boolean function_clause_recover_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "function_clause_recover_0")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
  ...
  static boolean not_comprehension(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_NOT_, "<expression>");
    result_ = !not_comprehension_0(builder_, level_ + 1);
    marker_.rollbackTo();
    result_ = exitErrorRecordingSection(builder_, level_, result_, false, _SECTION_NOT_, null);
    return result_;
  }
  ...
  // ('||')
  private static boolean not_comprehension_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "not_comprehension_0")) return false;
    boolean result_ = false;
    Marker marker_ = builder_.mark();
  ...
  static boolean period(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    Marker left_marker_ = (Marker)builder_.getLatestDoneMarker();
    if (!invalid_left_marker_guard_(builder_, left_marker_, "period")) return false;
    Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_DOT);
    if (!result_) {
      marker_.rollbackTo();
