...
public class ErlangParser implements PsiParser {
  ...
  public static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    ...
    create_token_set_(ERL_FIELD_TYPE, ERL_FUN_TYPE, ERL_FUN_TYPE_100_T, ERL_INT_TYPE,
      ERL_RECORD_LIKE_TYPE, ERL_TOP_TYPE_100_T, ERL_TYPE),
  };
  ...
  private static boolean atomic_2(PsiBuilder builder_, int level_) {
    ...
    while (result_) {
      ...
      int next_offset_ = builder_.getCurrentOffset();
      if (offset_ == next_offset_) {
        empty_element_parsed_guard_(builder_, offset_, "atomic_2");
        break;
      }
      offset_ = next_offset_;
    }
  ...
  public static boolean config_call_expression(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    exit_section_(builder_, level_, marker_, ERL_CONFIG_CALL_EXPRESSION, result_, pinned_, null);
    return result_ || pinned_;
  }
