...
public class ErlangParser implements PsiParser {
  ...
  public ASTNode parse(IElementType root_, PsiBuilder builder_) {
    ...
    else if (root_ == ERL_BIT_TYPE_LIST) {
    ...
    else if (root_ == ERL_EXPR_900_A) {
      result_ = expr_900_a(builder_, level_ + 1);
    }
    ...
    else if (root_ == ERL_FIELD_TYPES) {
      result_ = field_types(builder_, level_ + 1);
    }
    ...
    else if (root_ == ERL_TOP_TYPES) {
      result_ = top_types(builder_, level_ + 1);
    }
    ...
    else if (root_ == ERL_TYPE_SIGS) {
      result_ = type_sigs(builder_, level_ + 1);
    }
    ...
    else if (root_ == ERL_TYPED_EXPRS) {
      result_ = typed_exprs(builder_, level_ + 1);
    }
  ...
  private static final TokenSet[] EXTENDS_SETS_ = new TokenSet[] {
    TokenSet.create(ERL_ADDITIVE_EXPRESSION, ERL_BEGIN_END_EXPRESSION, ERL_BINARY_COMPREHENSION, ERL_BINARY_EXPRESSION,
      ...
      ERL_EXPR_400_A, ERL_EXPR_500_A, ERL_EXPR_700_A, ERL_EXPR_900_A,
      ERL_FUNCTION_CALL_EXPRESSION, ERL_FUN_EXPRESSION, ERL_IF_EXPRESSION, ERL_LC_EXPRESSION,
      ERL_LIST_COMPREHENSION, ERL_LIST_EXPRESSION, ERL_MAX_EXPRESSION, ERL_MULTIPLICATIVE_EXPRESSION,
      ERL_PARENTHESIZED_EXPRESSION, ERL_PREFIX_EXPRESSION, ERL_QUALIFIED_EXPRESSION, ERL_QUERY_EXPRESSION,
      ERL_RECEIVE_EXPRESSION, ERL_RECORD_EXPRESSION, ERL_TRY_EXPRESSION, ERL_TUPLE_EXPRESSION),
  };
  ...
  /* ********************************************************** */
  // !('spec' | 'callback') q_atom [attr_val | typed_attr_val | ('(' typed_attr_val ')')]
  public static boolean atom_attribute(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = atom_attribute_0(builder_, level_ + 1);
    result_ = result_ && q_atom(builder_, level_ + 1);
    result_ = result_ && atom_attribute_2(builder_, level_ + 1);
    if (result_) {
  ...
  // !('spec' | 'callback')
  private static boolean atom_attribute_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atom_attribute_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_NOT_);
    result_ = !atom_attribute_0_0(builder_, level_ + 1);
    marker_.rollbackTo();
  ...
  // ('spec' | 'callback')
  private static boolean atom_attribute_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atom_attribute_0_0")) return false;
    return atom_attribute_0_0_0(builder_, level_ + 1);
  }

  // 'spec' | 'callback'
  private static boolean atom_attribute_0_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atom_attribute_0_0_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, "spec");
    if (!result_) result_ = consumeToken(builder_, "callback");
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  // [attr_val | typed_attr_val | ('(' typed_attr_val ')')]
  private static boolean atom_attribute_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atom_attribute_2")) return false;
    atom_attribute_2_0(builder_, level_ + 1);
    return true;
  }

  // attr_val | typed_attr_val | ('(' typed_attr_val ')')
  private static boolean atom_attribute_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atom_attribute_2_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = attr_val(builder_, level_ + 1);
    if (!result_) result_ = typed_attr_val(builder_, level_ + 1);
    if (!result_) result_ = atom_attribute_2_0_2(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  // ('(' typed_attr_val ')')
  private static boolean atom_attribute_2_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atom_attribute_2_0_2")) return false;
    return atom_attribute_2_0_2_0(builder_, level_ + 1);
  }

  // '(' typed_attr_val ')'
  private static boolean atom_attribute_2_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "atom_attribute_2_0_2_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_PAR_LEFT);
  ...
  /* ********************************************************** */
  // '-' (atom_attribute | specification | callback_spec)
  ...
  public static boolean binary_comprehension(PsiBuilder builder_, int level_) {
    ...
    pinned_ = result_; // pin = 1
    result_ = result_ && report_error_(builder_, binary_expression(builder_, level_ + 1));
    result_ = pinned_ && report_error_(builder_, consumeToken(builder_, ERL_OR_OR)) && result_;
    result_ = pinned_ && report_error_(builder_, lc_exprs(builder_, level_ + 1)) && result_;
  ...
  public static boolean bit_type_list(PsiBuilder builder_, int level_) {
    ...
    if (result_) {
      marker_.done(ERL_BIT_TYPE_LIST);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  /* ********************************************************** */
  // expr_900_a colon_max_expression?
  ...
  /* ********************************************************** */
  // expression clause_guard? clause_body
  ...
  /* ********************************************************** */
  // expr_150_a expr_155_expression?
  ...
  private static boolean expr_100_a_1(PsiBuilder builder_, int level_) {
    ...
    expr_155_expression(builder_, level_ + 1);
    return true;
  }
  ...
  /* ********************************************************** */
  // ('='|'!') expr_100_a
  static boolean expr_155_expression(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expr_155_expression")) return false;
    if (!nextTokenIs(builder_, ERL_OP_EXL) && !nextTokenIs(builder_, ERL_OP_EQ)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
    final Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_);
    result_ = expr_155_expression_0(builder_, level_ + 1);
    pinned_ = result_; // pin = 1
  ...
  // ('='|'!')
  private static boolean expr_155_expression_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expr_155_expression_0")) return false;
    return expr_155_expression_0_0(builder_, level_ + 1);
  }

  // '='|'!'
  private static boolean expr_155_expression_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expr_155_expression_0_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_OP_EQ);
    if (!result_) result_ = consumeToken(builder_, ERL_OP_EXL);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  /* ********************************************************** */
  // function_call_expression | record_expression | colon_qualified_expression
  ...
  public static boolean expr_900_a(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expr_900_a")) return false;
    boolean result_ = false;
    final int start_ = builder_.getCurrentOffset();
    final Marker marker_ = builder_.mark();
    result_ = max_expression(builder_, level_ + 1);
    if (!result_) result_ = expr_900_a_1(builder_, level_ + 1);
    LighterASTNode last_ = result_? builder_.getLatestDoneMarker() : null;
    if (last_ != null && last_.getStartOffset() == start_ && type_extends_(last_.getTokenType(), ERL_EXPR_900_A)) {
      marker_.drop();
    }
    else if (result_) {
      marker_.done(ERL_EXPR_900_A);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  // (qualified_reference)
  private static boolean expr_900_a_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "expr_900_a_1")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = qualified_reference(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  /* ********************************************************** */
  // fun ((fun_clauses end) | (q_atom '/' integer) | (q_atom ':' q_atom '/' integer))
  ...
  // ((fun_clauses end) | (q_atom '/' integer) | (q_atom ':' q_atom '/' integer))
  ...
  private static boolean fun_expression_1_0(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = fun_expression_1_0_2(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  private static boolean fun_expression_1_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "fun_expression_1_0_2")) return false;
    return fun_expression_1_0_2_0(builder_, level_ + 1);
  }

  // q_atom ':' q_atom '/' integer
  private static boolean fun_expression_1_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "fun_expression_1_0_2_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = q_atom(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_COLON);
  ...
  private static boolean fun_type_100_t_1_0(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = fun_type_100_t_1_0_0(builder_, level_ + 1);
  ...
  // ('.' '.' '.')
  private static boolean fun_type_100_t_1_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "fun_type_100_t_1_0_0")) return false;
    return fun_type_100_t_1_0_0_0(builder_, level_ + 1);
  }

  // '.' '.' '.'
  private static boolean fun_type_100_t_1_0_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "fun_type_100_t_1_0_0_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_DOT);
  ...
  /* ********************************************************** */
  // colon_qualified_expression argument_list
  ...
  /* ********************************************************** */
  // q_atom argument_list clause_guard? clause_body
  ...
  /* ********************************************************** */
  // (expression lc_right_expression?) | (binary_expression '<=' expression)
  public static boolean lc_expression(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = lc_expression_1(builder_, level_ + 1);
    LighterASTNode last_ = result_? builder_.getLatestDoneMarker() : null;
  ...
  // (expression lc_right_expression?)
  private static boolean lc_expression_0(PsiBuilder builder_, int level_) {
    ...
    return lc_expression_0_0(builder_, level_ + 1);
  }
  ...
  private static boolean lc_expression_0_0_1(PsiBuilder builder_, int level_) {
    ...
    lc_right_expression(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean lc_expression_1(PsiBuilder builder_, int level_) {
    ...
    return lc_expression_1_0(builder_, level_ + 1);
  }
  ...
  static boolean lc_exprs(PsiBuilder builder_, int level_) {
  ...
  /* ********************************************************** */
  // '<-' expression
  static boolean lc_right_expression(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "lc_right_expression")) return false;
    if (!nextTokenIs(builder_, ERL_OP_LT_MINUS)) return false;
    boolean result_ = false;
    boolean pinned_ = false;
    final Marker marker_ = builder_.mark();
    enterErrorRecordingSection(builder_, level_, _SECTION_GENERAL_);
  ...
  public static boolean max_expression(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = atomic(builder_, level_ + 1);
    LighterASTNode last_ = result_? builder_.getLatestDoneMarker() : null;
  ...
  public static boolean q_var(PsiBuilder builder_, int level_) {
    ...
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = q_var_0(builder_, level_ + 1);
  ...
  // ('?'? var)
  private static boolean q_var_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "q_var_0")) return false;
    return q_var_0_0(builder_, level_ + 1);
  }

  // '?'? var
  private static boolean q_var_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "q_var_0_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = q_var_0_0_0(builder_, level_ + 1);
  ...
  // '?'?
  private static boolean q_var_0_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "q_var_0_0_0")) return false;
    consumeToken(builder_, ERL_QMARK);
    return true;
  }
  ...
  /* ********************************************************** */
  // receive ((cr_clauses end) | (after expression clause_body end) | (cr_clauses after expression clause_body end))
  ...
  // ((cr_clauses end) | (after expression clause_body end) | (cr_clauses after expression clause_body end))
  ...
  private static boolean receive_expression_1_0(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = receive_expression_1_0_2(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  // (after expression clause_body end)
  ...
  private static boolean receive_expression_1_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "receive_expression_1_0_2")) return false;
    return receive_expression_1_0_2_0(builder_, level_ + 1);
  }

  // cr_clauses after expression clause_body end
  private static boolean receive_expression_1_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "receive_expression_1_0_2_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = cr_clauses(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // (q_var '=' expression) | (q_atom '=' expression)
  public static boolean record_field(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = record_field_1(builder_, level_ + 1);
    if (result_) {
  ...
  private static boolean record_field_1(PsiBuilder builder_, int level_) {
    ...
    return record_field_1_0(builder_, level_ + 1);
  }
  ...
  public static boolean record_tuple(PsiBuilder builder_, int level_) {
    ...
    result_ = result_ && record_tuple_1(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // q_atom [(':' q_atom) | ('/' integer '::') | (':' q_atom '/' integer '::')]
  ...
  private static boolean spec_fun_1_0(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = spec_fun_1_0_2(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  // (':' q_atom '/' integer '::')
  private static boolean spec_fun_1_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "spec_fun_1_0_2")) return false;
    return spec_fun_1_0_2_0(builder_, level_ + 1);
  }

  // ':' q_atom '/' integer '::'
  private static boolean spec_fun_1_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "spec_fun_1_0_2_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_COLON);
    result_ = result_ && q_atom(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // spec_fun type_sigs
  static boolean spec_fun_with_args(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "spec_fun_with_args")) return false;
    if (!nextTokenIs(builder_, ERL_QMARK) && !nextTokenIs(builder_, ERL_ATOM)) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = spec_fun(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // (catch try_clauses end) | (catch try_clauses after exprs end) | (after exprs end)
  public static boolean try_catch(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = try_catch_2(builder_, level_ + 1);
    if (result_) {
  ...
  private static boolean try_catch_0_0(PsiBuilder builder_, int level_) {
    ...
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_CATCH);
    result_ = result_ && try_clauses(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_END);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  private static boolean try_catch_2(PsiBuilder builder_, int level_) {
    ...
    return try_catch_2_0(builder_, level_ + 1);
  }

  // after exprs end
  private static boolean try_catch_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "try_catch_2_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_AFTER);
    result_ = result_ && exprs(builder_, level_ + 1);
  ...
  /* ********************************************************** */
  // (expression clause_guard? clause_body) | (q_atom ':' expression clause_guard? clause_body) | (q_var ':' expression clause_guard? clause_body)
  public static boolean try_clause(PsiBuilder builder_, int level_) {
    ...
    if (!result_) result_ = try_clause_1(builder_, level_ + 1);
    if (!result_) result_ = try_clause_2(builder_, level_ + 1);
    if (result_) {
  ...
  private static boolean try_clause_0(PsiBuilder builder_, int level_) {
    ...
    return try_clause_0_0(builder_, level_ + 1);
  }
  ...
  private static boolean try_clause_0_0(PsiBuilder builder_, int level_) {
    ...
    final Marker marker_ = builder_.mark();
    result_ = expression(builder_, level_ + 1);
    result_ = result_ && try_clause_0_0_1(builder_, level_ + 1);
    result_ = result_ && clause_body(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // clause_guard?
  private static boolean try_clause_0_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "try_clause_0_0_1")) return false;
    clause_guard(builder_, level_ + 1);
    return true;
  }

  // (q_atom ':' expression clause_guard? clause_body)
  private static boolean try_clause_1(PsiBuilder builder_, int level_) {
    ...
    return try_clause_1_0(builder_, level_ + 1);
  }

  // q_atom ':' expression clause_guard? clause_body
  private static boolean try_clause_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "try_clause_1_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = q_atom(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_COLON);
    result_ = result_ && expression(builder_, level_ + 1);
    result_ = result_ && try_clause_1_0_3(builder_, level_ + 1);
    result_ = result_ && clause_body(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // clause_guard?
  private static boolean try_clause_1_0_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "try_clause_1_0_3")) return false;
    clause_guard(builder_, level_ + 1);
    return true;
  }

  // (q_var ':' expression clause_guard? clause_body)
  private static boolean try_clause_2(PsiBuilder builder_, int level_) {
    ...
    return try_clause_2_0(builder_, level_ + 1);
  }

  // q_var ':' expression clause_guard? clause_body
  private static boolean try_clause_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "try_clause_2_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = q_var(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_COLON);
    result_ = result_ && expression(builder_, level_ + 1);
    result_ = result_ && try_clause_2_0_3(builder_, level_ + 1);
    result_ = result_ && clause_body(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // clause_guard?
  private static boolean try_clause_2_0_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "try_clause_2_0_3")) return false;
    clause_guard(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean type_1_2(PsiBuilder builder_, int level_) {
    ...
    type_1_2_0(builder_, level_ + 1);
    return true;
  }

  // '(' top_types? ')'
  private static boolean type_1_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_1_2_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_PAR_LEFT);
    result_ = result_ && type_1_2_0_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_PAR_RIGHT);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // top_types?
  private static boolean type_1_2_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_1_2_0_1")) return false;
    top_types(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean type_4_0(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, ERL_BRACKET_LEFT);
    result_ = result_ && top_type(builder_, level_ + 1);
    result_ = result_ && type_4_0_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_BRACKET_RIGHT);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // (',' '.' '.' '.')?
  private static boolean type_4_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_4_0_2")) return false;
    type_4_0_2_0(builder_, level_ + 1);
    return true;
  }

  // (',' '.' '.' '.')
  private static boolean type_4_0_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_4_0_2_0")) return false;
    return type_4_0_2_0_0(builder_, level_ + 1);
  }

  // ',' '.' '.' '.'
  private static boolean type_4_0_2_0_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_4_0_2_0_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_COMMA);
    result_ = result_ && consumeToken(builder_, ERL_DOT);
  ...
  private static boolean type_5_0(PsiBuilder builder_, int level_) {
    ...
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_CURLY_LEFT);
    result_ = result_ && type_5_0_1(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_CURLY_RIGHT);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // top_types?
  private static boolean type_5_0_1(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_5_0_1")) return false;
    top_types(builder_, level_ + 1);
    return true;
  }
  ...
  private static boolean type_6(PsiBuilder builder_, int level_) {
    ...
    return type_6_0(builder_, level_ + 1);
  }

  // '#' q_atom '{' field_types? '}'
  private static boolean type_6_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_6_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_RADIX);
    result_ = result_ && q_atom(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_CURLY_LEFT);
    result_ = result_ && type_6_0_3(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_CURLY_RIGHT);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // field_types?
  private static boolean type_6_0_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_6_0_3")) return false;
  ...
  private static boolean type_10_0(PsiBuilder builder_, int level_) {
    ...
    result_ = consumeToken(builder_, ERL_FUN);
    result_ = result_ && consumeToken(builder_, ERL_PAR_LEFT);
    result_ = result_ && type_10_0_2(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_PAR_RIGHT);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  // fun_type_100_t?
  private static boolean type_10_0_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_10_0_2")) return false;
  ...
  /* ********************************************************** */
  // type_sig (';' type_sig)*
  public static boolean type_sigs(PsiBuilder builder_, int level_) {
  ...
  private static boolean type_spec_1(PsiBuilder builder_, int level_) {
    ...
    return type_spec_1_0(builder_, level_ + 1);
  }

  // '(' spec_fun_with_args ')'
  private static boolean type_spec_1_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "type_spec_1_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = consumeToken(builder_, ERL_PAR_LEFT);
    result_ = result_ && spec_fun_with_args(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_PAR_RIGHT);
    if (!result_) {
      marker_.rollbackTo();
    }
  ...
  /* ********************************************************** */
  // typed_expr | (typed_expr ',' typed_exprs) | (expression ',' typed_exprs) | (typed_expr ',' exprs)
  public static boolean typed_exprs(PsiBuilder builder_, int level_) {
    ...
    final Marker marker_ = builder_.mark();
    result_ = typed_expr(builder_, level_ + 1);
    if (!result_) result_ = typed_exprs_1(builder_, level_ + 1);
    if (!result_) result_ = typed_exprs_2(builder_, level_ + 1);
    if (!result_) result_ = typed_exprs_3(builder_, level_ + 1);
    if (result_) {
      marker_.done(ERL_TYPED_EXPRS);
    }
    else {
      marker_.rollbackTo();
    }
  ...
  private static boolean typed_exprs_1(PsiBuilder builder_, int level_) {
    ...
    return typed_exprs_1_0(builder_, level_ + 1);
  }
  ...
  private static boolean typed_exprs_1_0(PsiBuilder builder_, int level_) {
    ...
    result_ = typed_expr(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_COMMA);
    result_ = result_ && typed_exprs(builder_, level_ + 1);
    if (!result_) {
      marker_.rollbackTo();
    }
    else {
  ...
  // (expression ',' typed_exprs)
  private static boolean typed_exprs_2(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "typed_exprs_2")) return false;
    return typed_exprs_2_0(builder_, level_ + 1);
  }

  // expression ',' typed_exprs
  private static boolean typed_exprs_2_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "typed_exprs_2_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = expression(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_COMMA);
  ...
  // (typed_expr ',' exprs)
  private static boolean typed_exprs_3(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "typed_exprs_3")) return false;
    return typed_exprs_3_0(builder_, level_ + 1);
  }

  // typed_expr ',' exprs
  private static boolean typed_exprs_3_0(PsiBuilder builder_, int level_) {
    if (!recursion_guard_(builder_, level_, "typed_exprs_3_0")) return false;
    boolean result_ = false;
    final Marker marker_ = builder_.mark();
    result_ = typed_expr(builder_, level_ + 1);
    result_ = result_ && consumeToken(builder_, ERL_COMMA);
